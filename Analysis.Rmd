---
title: "Evolución del PIB por comunidades autónomas durante la democracia. Análisis técnico"
author: "Carlos Herrera Yagüe"
date: "25/3/2018"
output:
  github_document:
    toc: true
...
```{r big4-absolute-evolution, echo=FALSE}

big_regions <- df.m[df.m$region %in% 
              c("Andalucía","Cataluña","Madrid, Comunidad de", "Comunitat Valenciana"),]
g<-ggplot(big_regions,   aes(x=year,y=gdp_current_price/1e6,color=region))
g<-g+geom_line()+ylab("PIB a precios corrientes (miles de millones EUR)")
g<-g+scale_color_brewer(palette = "Set1")+geom_point(aes(shape=kind))
